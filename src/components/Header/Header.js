    ...
    <>
      {isMobile ? (
        ...
        <div className="">
          ...
          >
            <span
              className={`bg-white block transition-all duration-300 ease-out h-1 w-10 rounded-sm ${
                isOpen
                  ? "rotate-45 translate-y-2 md:translate-y-2"
                  : "-translate-y-1"
              }`}
            ></span>
            <span
              className={`bg-white block transition-all duration-300 ease-out h-1 w-10 rounded-sm my-1 ${
          ...
          >
            ...
            <div className="flex flex-col justify-center items-center gap-10 md:gap-24">
              ...
              <Link
                href={"/"}
                className="text-xl font-outfit p-4 md:p-8 text-white blurred-button hover:scale-90"
              >
                Book a Consultation
              </Link>
            </div>
